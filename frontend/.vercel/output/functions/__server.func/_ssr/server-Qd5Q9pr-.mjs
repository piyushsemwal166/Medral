...
import { t as createMiddleware } from "./createMiddleware-20C4mc5R.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CmZzKzFC.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DrHSqkFg.mjs"),
		import("./start-DDQJuxHD.mjs"),
